...
settings_list = [
    ...
    ['Scraper Settings', [
        ...
        setting('TorrentsDB Scraper Parameters','Please enter a valid TorrentsDB manifest url: ',scraper.services.torrentsdb, 'default_opts', entry="parameter", help='TorrentsDB is torrentio-compatible; it adds indexers torrentio lacks (knaben, rargb, ...). Default: https://torrentsdb.com/manifest.json', hidden=True),
